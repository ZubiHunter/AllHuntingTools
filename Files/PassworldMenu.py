...
if(op==1):
 os.system("clear")
 os.system("cd && cd AllHuntingTools && cd hasher && python2 hash.py && cd && cd AllHuntingTools && python2 MainMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd AllHuntingTools && cd hasherdoid && python2 hasherdotid.py && cd && cd AllHuntingTools && python2 MainMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd AllHuntingTools && cd hash-generator && python2 hashgen.py && cd && cd AllHuntingTools && python2 MainMenu.py")
elif(op==4):
 os.system("clear")
 os.system("cd && cd AllHuntingTools && cd Hash-Buster && python3 hash.py && cd && cd AllHuntingTools && python2 MainMenu.py")
elif(op==5):
 time.sleep(0.2)
