...
if(op==1):
 os.system("clear")
 os.system("cd && cd AllHuntingTools && cd AstraNmap && bash astranmap.sh && cd && cd AllHuntingTools && python2 MainMenu.py")
elif(op==8):
 os.system("clear")
 ...
 os.system("clear")
 os.system("cd && cd AllHuntingTools && cd TM-scanner && python2 tmscanner.py && cd && cd AllHuntingTools && python2 MainMenu.py")
elif(op==7):
 os.system("clear")
 os.system("cd && cd AllHuntingTools && cd MaxSubdoFinder && python2 maxteroit.py && cd && cd AllHuntingTools && python2 MainMenu.py")
elif(op==6):
 os.system("clear")
 os.system("cd && cd AllHuntingTools && cd sqlmap-dev && python sqlmap.py -wizard && cd && cd AllHuntingTools && python2 MainMenu.py")
elif(op==5):
 os.system("clear")
 os.system("cd && cd AllHuntingTools && cd rang3r && python2 rang3r.py --ip 192.168.0.1 && cd && cd AllHuntingTools && python2 MainMenu.py")
elif(op==9):
 time.sleep(0.2)
