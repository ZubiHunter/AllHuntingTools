...
os.system("cd && bash AllHuntingTools/.desing/desingpanel/desingpanel2.sh")
...
if(op==1):
 ...
 os.system("cd && cd AllHuntingTools && python src/CheckPackages.py && python2 Files/TermuxS2.py ")
elif(op==13):
 os.system("cd && cd AllHuntingTools && cp -r Termux-os /data/data/com.termux/files/home && cd && cd Termux-os && bash TermuxNewKeys.sh && cd && cd AllHuntingTools && python2 Files/TermuxS2.py")
elif(op==14):
 time.sleep(0.2)
