...
print("  \033[1;34m[ 03 ] >> \033[1;36;40mExit System - log out AllHuntingTools")
...
if(op==1):
 ...
 os.system("clear")
 os.system("cd && cd AllHuntingTools && cd trape && python trape.py && cd && cd AllHuntingTools && python2 MainMenu.py")
elif(op==3):
 time.sleep(0.2)
