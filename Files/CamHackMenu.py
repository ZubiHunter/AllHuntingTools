...
if(op==1):
 os.system("clear")
 os.system("cd && cd AllHuntingTools && cd Cam-Hackers && python3 cam-hackers.py && cd && cd AllHuntingTools && python2 MainMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd AllHuntingTools && cd grabcam && bash grabcam.sh && cd && cd AllHuntingTools && python2 MainMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd AllHuntingTools && cd CamHack && bash CamHack.sh && cd && cd AllHuntingTools && python2 MainMenu.py")
elif(op==4):
 time.sleep(0.2)
