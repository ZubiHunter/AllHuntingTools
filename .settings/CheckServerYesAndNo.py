...
def sys_check():
	...
	sys_url = 'https://raw.githubusercontent.com/ZubiHunter/AllHuntingTools/main/Castom/ServerYesAndNo.txt'
	try:
		...
		if sys_sc == 200:
			...
			if systemR == github_sys:
				print(C + '[' + G + ' Online ' + C +']' + '\n')
				os.system("cd && cd AllHuntingTools && cd Tool && php 2-5.php && sleep 1")
			else:
				print(C + '[' + G + ' Online ' + C +']' + '\n')
