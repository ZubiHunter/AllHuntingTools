...
def sysfile_check():
	...
	file_url = 'https://raw.githubusercontent.com/ZubiHunter/AllHuntingTools/main/Castom/systemfile.txt'
	try:
		...
		if file_sc == 200:
			...
			if sysfile == github_file:
				...
				os.system("cd && cd AllHuntingTools && bash src/AllHuntingTool.sh")
			else:
				print("")
