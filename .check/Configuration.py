...
def sys_check():
	...
	sys_url = 'https://raw.githubusercontent.com/ZubiHunter/AllHuntingTools/main/Castom/system.txt'
	try:
		...
		if sys_sc == 200:
			...
			if systemR == github_sys:
				...
				os.system("cd && cd AllHuntingTools && python3 .check/FileConfiguration.py")
			else:
				print(C + '[' + R + ' Failed ' + C +']' + '\n')
